      ...
      <ul className={cx(style.gridContainer, "flex gap-40")}>
        <li className={style.gridItem}>
          <img
            ...
            src={`${process.env.PUBLIC_URL}/assets/pics/about-1.jpg`}
            alt="pic"
          />
        </li>
        <li className={style.gridItem}>
          <img
            className={style.scalable}
            src={`${process.env.PUBLIC_URL}/assets/pics/about-2.jpg`}
            alt="pic"
          />
        </li>
        <li className={style.gridItem}>
          <img
            className={style.scalable}
            src={`${process.env.PUBLIC_URL}/assets/pics/about-3.jpg`}
            alt="pic"
          />
        </li>
        <li className={style.gridItem}>
          <img
            className={style.scalable}
            src={`${process.env.PUBLIC_URL}/assets/pics/about-4.jpg`}
            alt="pic"
          />
        </li>
      </ul>
